...
import canopy
import codec
from rat_mqtt import config
from fps import FPS

config['server'] = '10.0.0.21'
config['ssid'] = 'Mainstage'
config['wifi_pw'] = 'schweppes'

# install mqtt with `mpremote mip install github:peterhinch/micropython-mqtt`
